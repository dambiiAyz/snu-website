              ...
              <div className="row">
                  ...
                  <div className="tp-footer-widget footer-col-4-1 mb-50">
                    ...
                    <div className="tp-footer-widget-content">
                      <div className="tp-footer-talk mb-20">
                        ...
                        <h4><a href="tel:976-88545655">+976 8854 5655</a></h4>
                      </div>
                      <div className="tp-footer-contact">
                        <div className="tp-footer-contact-item d-flex align-items-start">
                          ...
                          <div className="tp-footer-contact-content">
                            <p><a href="mailto:snueshop@gmail.com">snueshop@gmail.com</a></p>
                          </div>
                        </div>
                        <div className="tp-footer-contact-item d-flex align-items-start">
                          <div className="tp-footer-contact-icon">
                          ...
                          <div className="tp-footer-contact-content">
                            <p><a href="https://www.google.com/maps/place/Sleepy+Hollow+Rd,+Gouverneur,+NY+13642,+USA/@44.3304966,-75.4552367,17z/data=!3m1!4b1!4m6!3m5!1s0x4cccddac8972c5eb:0x56286024afff537a!8m2!3d44.3304928!4d-75.453048!16s%2Fg%2F1tdsjdj4" target="_blank">Khan uul duureg <br /> Misheel expo, Ulaanbaatar, Mongolia </a></p>
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <div className="col-xl-2 col-lg-3 col-md-4 col-sm-6">
                  <div className="tp-footer-widget footer-col-4-2 mb-50">
                    <h4 className="tp-footer-widget-title">{t('footer.myAccountTitle')}</h4>
                    <div className="tp-footer-widget-content">
                      <ul>
                        <li><a href="#">{t('footer.trackOrders')}</a></li>
                        <li><a href="#">{t('footer.shipping')}</a></li>
                        <li><a href="#">{t('footer.wishlist')}</a></li>
                        <li><a href="#">{t('footer.myAccountLink')}</a></li>
                ...
                <div className="col-xl-3 col-lg-2 col-md-4 col-sm-5">
                  <div className="tp-footer-widget footer-col-4-3 mb-50">
                    <h4 className="tp-footer-widget-title">{t('footer.informationTitle')}</h4>
                    <div className="tp-footer-widget-content">
                      <ul>
                ...
                <div className="col-xl-4 col-lg-4 col-md-6 col-sm-7">
                  <div className="tp-footer-widget footer-col-4-4 mb-50">
                    <h4 className="tp-footer-widget-title">{t('footer.subscribeTitle')}</h4>
                    <div className="tp-footer-widget-content">
                      <div className="tp-footer-subscribe">
                        ...
                        <div className="tp-footer-social-4 tp-footer-social">
                          <h4 className="tp-footer-social-title-4">{t('footer.followUsOn')}</h4>
              ...
              <div className="tp-footer-bottom-wrapper">
                <div className="row align-items-center">
                  <div className="col-md-6">
                    ...
                    <p>
                      {t('footer.copyright', { year: new Date().getFullYear(), by: 'f2' })}
                        <Link href="/">Snu</Link>.
                      </p>
                    </div>
                  </div>
