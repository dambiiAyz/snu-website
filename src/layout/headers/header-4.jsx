...
import logo_white from '@assets/img/logo/snu_logo.png';
import logo_dark from '@assets/img/logo/snu_logo.png';
            ...
            <div className="container-fluid">
              <div className="row align-items-center">
                <div className="col-xl-2 col-lg-2 col-6">
                  <div className="logo">
                    <Link href="/">
                      <Image className="logo-light" src={logo_white} alt="logo" height={50} />
                      <Image className="logo-dark" src={logo_dark} alt="logo" height={50} />
                    </Link>
                  </div>
                </div>
