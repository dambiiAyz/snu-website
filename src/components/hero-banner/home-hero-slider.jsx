...
const sliderData = [
  {
    id: 1,
    pre_title: { textKey: "home.slider.preTitle", price: 274 },
    titleKey: "home.slider.title1",
    subtitle: {
      text_1_key: "home.slider.subtitleText1",
      percent: 35,
      text_2_key: "home.slider.subtitleText2",
    },
    img: slider_img_1,
    green_bg: true,
  },
  {
    id: 2,
    pre_title: { textKey: "home.slider.preTitle", price: 999 },
    titleKey: "home.slider.title2",
    subtitle: {
      text_1_key: "home.slider.subtitleText1",
      percent: 10,
      text_2_key: "home.slider.subtitleText2",
                ...
                <div className="row align-items-center">
                  <div className="col-xl-5 col-lg-6 col-md-6">
                    <div className="tp-slider-content p-relative z-index-1">
                      <span>
                        {t(item.pre_title.textKey)} <b>{formatCurrency(item.pre_title.price, 0)}</b>
                      </span>
                      <h3 className="tp-slider-title">{t(item.titleKey)}</h3>
                      <p>
                        {t(item.subtitle.text_1_key)}
                        <span>
                          -{item.subtitle.percent}%
                          <TextShape />
                        </span>{" "}
                        {t(item.subtitle.text_2_key)}
                      </p>

                      <div className="tp-slider-btn">
                        <Link href="/shop" className="tp-btn tp-btn-2 tp-btn-white">
                          {t("home.slider.shopNow")}
                          {" "} <ArrowRightLong />
                        </Link>
                      </div>
                    </div>
