              ...
              <div className="col-xl-9 col-lg-8">
                <div className="tp-cart-list mb-25 mr-30">
                  ...
                  <table className="table">
                    <thead>
                      <tr>
                        <th colSpan="2" className="tp-cart-header-product">{t('cart.table.product')}</th>
                        <th className="tp-cart-header-price">{t('cart.table.price')}</th>
                        <th className="tp-cart-header-quantity">{t('cart.table.quantity')}</th>
                        <th></th>
                      </tr>
                    </thead>
                    <tbody>
