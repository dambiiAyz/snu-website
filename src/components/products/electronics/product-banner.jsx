...
const bannerProducts = [
  {
    id: 1,
    banner_bg_txt_key: 'home.productBanner.bgText',
    subtitle_key: 'home.productBanner.subtitle',
    title_line_1_key: 'home.productBanner.titleLine1',
    title_line_2_key: 'home.productBanner.titleLine2',
    oldPrice: 320,
    newPrice: 288,
    img: banner_img_1,
  },
            ...
            <Swiper {...slider_setting} modules={[Pagination, EffectFade]} className="tp-product-banner-slider-active swiper-container">
              {bannerProducts.map((item, i) => (
                <SwiperSlide key={item.id} className="tp-product-banner-inner theme-bg p-relative z-index-1 fix">
                  <h4 className="tp-product-banner-bg-text">{t(item.banner_bg_txt_key)}</h4>
                  <div className="row align-items-center">
                    <div className="col-xl-6 col-lg-6">
                      <div className="tp-product-banner-content p-relative z-index-1">
                        <span className="tp-product-banner-subtitle">{t(item.subtitle_key)}</span>
                        <h3 className="tp-product-banner-title">
                          {t(item.title_line_1_key)} <br /> {t(item.title_line_2_key)}
                        </h3>
