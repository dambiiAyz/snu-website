...
const ProductGadgetArea = () => {
  ...
  function GadgetBanner() {
    ...
    const banner_data = [
      {
        bg: b_bg_1,
        title_line_1_key: 'home.gadget.banner.selectedLine1',
        title_line_2_key: 'home.gadget.banner.selectedLine2',
        price: 99
      },
      {
        bg: b_bg_2,
        title_line_1_key: 'home.gadget.banner.topRatedLine1',
        title_line_2_key: 'home.gadget.banner.topRatedLine2',
        price: 55
      },
    ]
    return (
          ...
          style={{ backgroundImage: `url(${b.bg.src})`}}>
            <div className="tp-product-gadget-banner-content">
              <span className="tp-product-gadget-banner-price">
                {t('home.gadget.banner.price', { price: b.price.toFixed(2) })}
              </span>
              <h3 className="tp-product-gadget-banner-title">
                <Link href="/shop">
                  {t(b.title_line_1_key)} <br /> {t(b.title_line_2_key)}
                </Link>
              </h3>
            </div>
          </SwiperSlide>
              ...
              <div className="tp-product-gadget-sidebar mb-40">
                <div className="tp-product-gadget-categories p-relative fix mb-10">
                  ...
                  <h3 className="tp-product-gadget-categories-title">
                    {t('home.gadget.categoriesLine1')} <br /> {t('home.gadget.categoriesLine2')}
                  </h3>
