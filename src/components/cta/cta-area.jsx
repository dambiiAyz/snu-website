        ...
        <div className="row align-items-center">
          <div className="col-xl-7 col-lg-7">
            <div className="tp-subscribe-content">
              <span>{t('home.cta.sale')}</span>
              <h3 className="tp-subscribe-title">{t('home.cta.title')}</h3>
            </div>
          </div>
            ...
            <div className="tp-subscribe-form">
              <form action="#">
                <div className="tp-subscribe-input">
                  <input type="email" placeholder={t('home.cta.emailPlaceholder')} />
                  <button type="submit">{t('home.cta.subscribeButton')}</button>
                </div>
              </form>
            </div>
          </div>
