      ...
      <div className="tp-product-details-tab-nav tp-tab">
        <nav>
          <div className="nav nav-tabs justify-content-center p-relative tp-product-tab" id="navPresentationTab" role="tablist">
            <NavItem active={true} linkRef={activeRef} id="desc" title={t('productDetails.tabs.description')} />
            <NavItem id="additional" title={t('productDetails.tabs.additionalInfo')} />
            <NavItem id="review" title={t('productDetails.tabs.reviews', { count: reviews.length })} />
              ...
              <div className="row">
                <div className="col-lg-6">
                  <div className="tp-product-details-review-statics">
                    ...
                    <div className="tp-product-details-review-list pr-110">
                      <h3 className="tp-product-details-review-title">{t('productDetails.reviews.title')}</h3>
                      {reviews.length === 0 && (
                        <h3 className="tp-product-details-review-title">
                          {t('productDetails.reviews.empty')}
                        </h3>
                      )}
                ...
                <div className="col-lg-6">
                  <div className="tp-product-details-review-form">
                    <h3 className="tp-product-details-review-form-title">{t('productDetails.reviews.formTitle')}</h3>
                    <p>{t('productDetails.reviews.note')}</p>
                    {/* form start */}
